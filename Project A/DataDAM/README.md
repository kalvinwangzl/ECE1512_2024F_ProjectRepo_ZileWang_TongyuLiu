...
## File Tree
This folder contains all neccesary code files and supplemental material for the main paper, as part of Project A Task 1.
```
.
...
├── mhist_dataset           # Provided mhist_dataset of Project A
└── README.md
```

## How to use
Training and evaluation and be done by editing and running main_DataDAM.py


## HyperParameter Table
For reproducibility, the original author outline their associated hyperparameters below:
<p align="center">
...
The original authors provide saved tensors of the dataset and frozen evaluation models trained on the respective distilled dataset on their HuggingFace Page: https://huggingface.co/datasets/uoft-dsp-lab/DataDAM
